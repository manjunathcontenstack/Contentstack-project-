...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const setupMarquee = () => {
    ...
    animationId = requestAnimationFrame(loop);
    row.animationId = animationId; // Store for cleanup
  };
  setupMarquee();
...
// Set current year for footer copyright & Initialize counter animations
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize counter animations (replacing React components)
